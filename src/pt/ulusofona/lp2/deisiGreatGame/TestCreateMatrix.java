...
public class TestCreateMatrix {
    ...
    public String [][]createMatrix4Players2(){
        String[][] playersInfo = new String[4][4];
        playersInfo[0][0] = "12";
        playersInfo[0][1] = "Aoao";
        playersInfo[0][2] = "java";
        ...
        playersInfo[1][3] = "Brown";
        playersInfo[2][0] = "28";
        playersInfo[2][1] = "Covane";
        playersInfo[2][2] = "GoLang;Lua;Rust";
        playersInfo[2][3] = "Purple";
        playersInfo[3][0] = "69";
        playersInfo[3][1] = "Alaudio";
        playersInfo[3][2] = "C;C++;C#";
        playersInfo[3][3] = "Green";
        return playersInfo;
    }
    ...
    public String [][]createEffectsMatrix3(){
        String[][] effects = new String[2][4];
        effects[0][0] = "0";
        effects[0][1] = "5";
        effects[0][2] = "2";
    ...
    public String [][]createEffectsMatrix6(){
        String[][] effects = new String[2][4];
        effects[0][0] = "1";
        effects[0][1] = "2";
        effects[0][2] = "3";
    ...
    public String [][]createEffectsMatrix7(){
        String[][] effects = new String[2][4];
        effects[0][0] = "0";
        effects[0][1] = "7";
        effects[0][2] = "2";
